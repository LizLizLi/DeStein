...
class MptAttention(nn.Module):
    ...
    def __init__(self, config: MptConfig):
        ...
        # 干预相关
        self.before_mergehead = nn.Identity()  # reversal
    ...
    def forward(
        ...
        # TODO： 干预 for hook convience
        context_states = self.before_mergehead(context_states)
...
class MptBlock(nn.Module):
    ...
    def forward(
        ...
        hidden_states = self.resid_attn_dropout(attn_outputs)
...
class MptForCausalLMWithReversal(MptPreTrainedModel):
    _tied_weights_keys = ["lm_head.weight"]
